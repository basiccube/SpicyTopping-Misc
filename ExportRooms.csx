...
// Slightly modified again by basiccube
// to work with newer versions of UTMT
// and to be used within Spicy Topping with UTMT-CLI
// (so for that reason the output path is hardcoded)
